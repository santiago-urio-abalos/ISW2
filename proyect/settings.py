...
EMAIL_HOST_PASSWORD = 'limj ylqj yixo olky'  # Contraseña de aplicación Gmail
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # carpeta donde está admin/css/theme.css
]
...
SECRET_KEY = 'django-insecure-k%p0m-z0q2&1r!8wn#&nzt2ztfixhtor5q)57um5qo#(hyneub'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'newhope.azurewebsites.net']

CSRF_TRUSTED_ORIGINS = [
    'https://newhope.azurewebsites.net',
]
